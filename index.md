...
venue: "at this place"        # brief name of host site without address (e.g., "Euphoric State University")
address: "the address"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
country: "ee"      # lowercase two-letter ISO country code such as "fr" (see https://en.wikipedia.org/wiki/ISO_3166-1#Current_codes)
...
humandate: "12 June 2020"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "3pm-5pm"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
startdate: 2020-06-12     # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2020-06-12        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Pat Frog"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["a few people"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["fixme@example.org"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
collaborative_notes:   https://pad.carpentries.org/2019-07-19-sydney           # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
